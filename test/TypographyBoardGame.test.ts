...
import { TypographyBoardGame } from '../src/games/busyBoard/TypographyBoardGame';
...
describe('TypographyBoardGame (Board 5)', () => {
  let game: TypographyBoardGame;
  ...
  it('should initialize typography board cleanly', () => {
